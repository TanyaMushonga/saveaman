  ...
  return (
    <form className="space-y-5">
      ...
      <div className="form-control">
        ...
        <input
          type="date"
          className="input input-bordered bg-blue-600 text-slate-300 placeholder:text-slate-300"
          required
        />
      </div>
      ...
      <div className="form-control">
        ...
        <select className="select select-bordered w-full max-w-auto bg-blue-600 text-slate-300">
          <option>Male</option>
      ...
      <div className="form-control">
        <label className="label">
          <span className="label-text text-white">What is your role</span>
        </label>
        <input
          type="text"
          className="input input-bordered bg-blue-600 placeholder:text-slate-300"
          placeholder="permanent executive"
          required
        />
      </div>
      <div className="form-control">
      ...
      <div className="form-control">
        <label className="label">
          <span className="label-text text-white">Confirm your password</span>
        </label>
        <input
          type="password"
          className="input input-bordered bg-blue-600 placeholder:text-slate-300"
